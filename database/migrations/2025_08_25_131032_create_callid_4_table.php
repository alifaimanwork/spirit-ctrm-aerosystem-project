...
return new class extends Migration
{
    ...
    {
        Schema::create('callid_4', function (Blueprint $table) {
            $table->id();
            ...
            $table->string('spreaderposition');
            $table->string('side1loosehole_2nos_2');
            $table->string('distancelowerparttotrackbase_2');
            $table->string('rivettail_2nos_1');
            $table->string('rivettail_2nos_2');
